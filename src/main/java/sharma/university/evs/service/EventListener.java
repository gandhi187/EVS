...
public class EventListener implements MqttCallback {
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        ...
        try {
            ...
            System.out.println(epService.getEPAdministrator().getConfiguration());
            System.out.println(epService.getEPAdministrator().getConfiguration().getEventType(eventName));
